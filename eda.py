...
# 1. Extrair os tickers e adicionar o sufixo '.SA' para o Yahoo Finance
# A primeira coluna do CSV é o 'Código' (Ticker)
...
dados_ibov_clean = dados_ibov_clean.ffill().dropna(how='all')

# ==============================================================================
# 6. CÁLCULO DE RETORNOS LOGARÍTMICOS
# ==============================================================================
